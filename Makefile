...
OBJECTS += CMPS12_KRAI/CMPS12_KRAI.o
OBJECTS += Motor/Motor.o
OBJECTS += PID/PID.o
OBJECTS += encoderKRAI/encoderKRAI.o
OBJECTS += main.o
OBJECTS += millis/millis.o
OBJECTS += I2CLCD/I2CLCD.o
OBJECTS += TextLCD/TextLCD.o
OBJECTS += eeprom/eeprom.o
...
INCLUDE_PATHS += -I../.
INCLUDE_PATHS += -I../CMPS12_KRAI
INCLUDE_PATHS += -I../Motor
INCLUDE_PATHS += -I../PID
INCLUDE_PATHS += -I../encoderKRAI
INCLUDE_PATHS += -I../I2CLCD
INCLUDE_PATHS += -I../TextLCD
INCLUDE_PATHS += -I../eeprom
...
C_FLAGS += -DTARGET_M4
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1541310347.13
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1541310347.13
...
ASM_FLAGS += -I../.
ASM_FLAGS += -I../CMPS12_KRAI
ASM_FLAGS += -I../Motor
ASM_FLAGS += -I../PID
ASM_FLAGS += -I../I2CLCD
ASM_FLAGS += -I../TextLCD
ASM_FLAGS += -I../eeprom
ASM_FLAGS += -I../encoderKRAI
ASM_FLAGS += -I../mbed
...
ASM_FLAGS += -I../millis
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/a/ad0f85b13f1e6cd7914b9aaea66397af/HOT_Wheels_Millis/mbed_config.h
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -c
ASM_FLAGS += -Wall
